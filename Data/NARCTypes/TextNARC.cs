...
namespace NewEditor.Data.NARCTypes
{
    public class TextNARC : NARC
    {
        ...
        public static string FormatText(string text) => text.Replace("[C]", "\\xf000븁\\x0000\\xfffe")
                    ...
                    .Replace("[gray]", "\\xf000＀\\x0001\\x0000")
                    .Replace("[red]", "\\xf000＀\\x0001\\x0001")
                    .Replace("[blue]", "\\xf000＀\\x0001\\x0002")
                    .Replace("[yellow]", "\\xf000＀\\x0001\\x0003")
                    .Replace("[green]", "\\xf000＀\\x0001\\x0004")
                    .Replace("[orange]", "\\xf000＀\\x0001\\x0005")
                    .Replace("[pink]", "\\xf000＀\\x0001\\x0006")
